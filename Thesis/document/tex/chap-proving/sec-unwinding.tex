...
preserves certain function calls to prevent exponential growth, 
and still provides more and more accurate under-approximation in each
iteration.
\todo[inline]{
...
\begin{equation*}
  \textsc{duplicate}(P, \fun{f}, i) = P\cup\{G^{\fun{f}_i}\} \text{ where }
  G^{\fun{f}_i} = G^\fun{f}
\end{equation*}
